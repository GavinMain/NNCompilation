import time
import os
from _model import LanguageModel, train_step, BytePairTokenizer, PretrainDataset, device
import torch
...
def main():
    ...
    if not os.path.exists(vocab_file):
        tokenizer.build_vocab(text, special_tokens=special_tokens, max_vocab_size=max_vocab_size, min_frequency=min_frequency)
    ...
    print("LLM_01 Pretrain: PyTorch Layers with Byte Pair Tokenizer:")
    print("Device: ", device)
